  ...
  return (
    <header className="mt-12 sm:mt-16 text-sm tracking-widest">
      ...
      <div id="mobile-nav" className="text-gray-800 flex flex-col px-8 pt-12 text-lg font-medium sm:hidden hidden">
        ...
        <Link className="fadeInDown faster animated pt-3 pb-8 px-4 hover:text-gray-900 hover:line-through focus:bg-gray-100 border-b-2 border-black" to="/contact">Hire Me</Link>
      </div>
    </header>
  );
}
