...
function Hero() {
  return (
    <section className="max-w-6xl mx-auto flex flex-col md:justify-center p-8 my-24 md:mt-32">
      <ScrollAnimation animateIn='fadeInUp'>
        <h1 className="text-4xl sm:text-5xl md:text-6xl leading-tight font-serif font-bold">
      ...
      <h2 className="text-3xl text-center font-bold p-8 mb-8">Case Study</h2>
        <div className="w-full flex flex-col mb-8 px-8">
          <div>
            ...
            <Link to="/facebook">
              <div className="flex items-start cross-noodle bg-blue-100 p-8 sm:py-20 sm:px-24 overflow-hidden">
                  <ScrollAnimation animateIn='fadeInUp' className="mx-2 md:mx-4 rounded sm:rounded-xl shadow-lg overflow-hidden">
                    <img className="" src={Framework1} alt="Wireframe"/>
                  </ScrollAnimation>
                  <ScrollAnimation animateIn='fadeInUp' delay={200} className="mx-2 md:mx-4 rounded sm:rounded-xl shadow-lg overflow-hidden">
                    <img className="" src={Framework2} alt="Wireframe"/>
                  </ScrollAnimation>
                  <ScrollAnimation animateIn='fadeInUp' delay={300} className="mx-2 md:mx-4 rounded sm:rounded-xl shadow-lg overflow-hidden">
                    <img className="" src={Framework3} alt="Wireframe"/>
                  </ScrollAnimation>
                  <ScrollAnimation animateIn='fadeInUp' delay={500} className="hidden md:block mx-2 md:mx-4 rounded sm:rounded-xl shadow-lg overflow-hidden">
...
function Selected() {
  return (
    <section className="max-w-6xl mx-auto py-4 mb-16">
      ...
      <div className="w-full flex flex-col md:flex-row">
        <div className="md:w-3/5 flex flex-col mb-8 px-8">
        <div className="flex items-start dots bg-red-100 p-6 sm:py-12 sm:px-24 overflow-hidden">
          ...
          <ScrollAnimation animateIn='fadeInDown' className="mx-2 md:mx-4 rounded sm:rounded-xl shadow-2xl overflow-hidden">
            <img className="" src={Redesign1} alt="Wireframe"/>
          </ScrollAnimation>
          <ScrollAnimation animateIn='fadeInUp' className="mx-2 md:mx-4 mt-6 rounded sm:rounded-xl shadow-xl overflow-hidden">
